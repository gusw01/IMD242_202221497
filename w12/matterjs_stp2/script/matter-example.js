...
// var ground = Bodies.rectangle(400, 610, 810, 60, { isStatic: true }); //x y w h {option}
// 월드에 집어넣을 바디를 생성
// 근데 2개는 박스, 하나는 같은 박스지만, 스태틱 처리되서 바닥으로 역할함
let boxA = Bodies.rectangle(400, 200, 80, 80); //x y w h
...
// 월드에다가 만든 애들을 탈탈 집어넣기. 집어넣기 위해서 콤포지트를 사용함
...
// 러너 모듈에게 생성된 러너와 생성된 엔진을 집어넣고 시동걸기 (무한 생성 보장)
